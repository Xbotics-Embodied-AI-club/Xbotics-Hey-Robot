"""Feetech SMS/STS servo protocol adapter for SO101 and LeKiwi robots.
...
# Public alias for tests that need the raw stateful protocol handler.
StatefulPacketHandler = _StatefulAdapter
