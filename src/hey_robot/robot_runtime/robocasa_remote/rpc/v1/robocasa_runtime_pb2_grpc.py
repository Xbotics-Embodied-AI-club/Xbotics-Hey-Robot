...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in hey_robot/robot_runtime/robocasa_remote/rpc/v1/robocasa_runtime_pb2_grpc.py depends on"
