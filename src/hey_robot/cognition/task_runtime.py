...
from hey_robot.cognition.execution_feedback import ExecutionFeedback
from hey_robot.cognition.injection import RobotTurnInjector
from hey_robot.cognition.memory import MemoryBroker, SceneMemoryRecord, SceneMemoryStore
from hey_robot.cognition.runtime.response_policy import (
    looks_like_internal_agent_protocol,
)
from hey_robot.cognition.task_run import TaskRun, TaskRunStore
...
class RecoveryManager:
    ...
    def __init__(self, planner: TaskRecoveryPlanner | None = None) -> None:
        if planner is None:
            from hey_robot.cognition.tasks.recovery import TaskRecoveryPlanner
    ...
    def _escalate(
        ...
        from hey_robot.cognition.tasks.recovery import TaskRecoveryDecision
...
def _intent_from_turn_metadata(turn: UserTurn):
    from hey_robot.cognition.interaction import UserInteractionIntent
