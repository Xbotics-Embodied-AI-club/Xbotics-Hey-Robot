"""Auto-discovery of :class:`~hey_robot.cognition.tools.base.Tool` subclasses.

Scans the ``hey_robot.cognition.tools`` package for concrete tool classes, then
...
logger = logging.getLogger("hey_robot.cognition.tools.loader")
...
class ToolLoader:
    ...
    def __init__(
        ...
        if package is None:
            import hey_robot.cognition.tools as _pkg
