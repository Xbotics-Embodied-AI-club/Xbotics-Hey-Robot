...
discovers tools via :class:`~hey_robot.cognition.tools.loader.ToolLoader` and
registers them in a :class:`~hey_robot.cognition.tools.registry.ToolRegistry`.
...
from hey_robot.cognition.tools.schema import Schema
