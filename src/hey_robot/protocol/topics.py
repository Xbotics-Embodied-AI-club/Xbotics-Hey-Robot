...
class Topics:
    ...
    goal_command: str = "goal.command"
    goal_event: str = "goal.event"
    agent_deliberation: str = "agent.deliberation"
    agent_deliberation_result: str = "agent.deliberation.result"
