...
class TestXLeRobotSimSkillAdapter:
    @staticmethod
    def _adapter() -> object:
        from hey_robot.robot_runtime.simulation.skill_adapter import (
    ...
    def test_manipulate_uses_required_model_service(self) -> None:
        ...
        assert ManipulateSkill.spec.required_resources == (
            "arm",
            "gripper",
            "camera",
        )
    ...
    def test_decode_uses_embodiment_actuator_layout_and_gripper_range(self) -> None:
        from hey_robot.robot_runtime.classic import ClassicEmbodimentProfile
        from hey_robot.robot_runtime.embodiments import EmbodimentProfile
        from hey_robot.robot_runtime.simulation.skill_adapter import (
            XLeRobotSimSkillAdapter,
        )
