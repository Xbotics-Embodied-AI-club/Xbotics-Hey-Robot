...
from hey_robot.cognition.tools import loader as loader_module
...
def test_discover_with_test_classes():
    from hey_robot.cognition.tools.base import tool_parameters
    from hey_robot.cognition.tools.schema import tool_parameters_schema
