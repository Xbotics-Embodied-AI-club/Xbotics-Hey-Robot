...
class TestWaitTool:
    async def test_wait_no_reason(self):
        from hey_robot.cognition.tools.wait import WaitTool
...
class TestGetRobotStatusTool:
    async def test_returns_snapshot_summary(self):
        from hey_robot.cognition.tools.get_robot_status import GetRobotStatusTool
...
class TestMemorySearch:
    async def test_semantic_mode(self):
        from hey_robot.cognition.tools.search_memory import SearchMemoryTool
...
class TestMemoryWrite:
    async def test_remember_event(self):
        from hey_robot.cognition.tools.write_memory import WriteMemoryTool
...
class TestRequestPerceptionTool:
    async def test_submits_internal_skill_and_queries_evidence(self):
        from hey_robot.cognition.tools.request_perception import RequestPerceptionTool
...
class TestTaskContextTool:
    async def test_get_task_context_returns_task_feedback_and_recovery(self):
        from hey_robot.cognition.tools.get_task_context import GetTaskContextTool
...
class TestToolBaseBehavior:
    ...
    def test_validate_rejects_non_object_schema(self):
        from hey_robot.cognition.tools.base import Tool
...
class TestToSpecRuntimeAdapter:
    ...
    def test_registry_produces_runtime_adapter_list(self):
        ...
        from hey_robot.cognition.tools import ToolRegistry as NewRegistry
