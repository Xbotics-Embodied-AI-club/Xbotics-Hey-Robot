...
from hey_robot.cognition.memory.scene import (
    SceneMemoryRecord,
    SceneMemoryStore,
    SceneSummarizer,
    _dict,
...
class TestSceneSummarizer:
    ...
    def test_from_understanding(self) -> None:
        from hey_robot.cognition.perception.scene import SceneObject, SceneUnderstanding
...
class TestSceneMemoryStore:
    ...
    def test_read_skips_corrupted_lines(self) -> None:
        ...
        from hey_robot.cognition.memory.scene import _sanitize
