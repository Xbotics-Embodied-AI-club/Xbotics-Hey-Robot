...
- [Harness Engineering for Self-Improvement](#harness-engineering-for-self-improvement)
...
|---|---|
| File system | - File discovery: glob, grep, ls<br>- File read: read, read_many<br>- File modification: write (a whole new file); edit (string exact-match replacement); multi_edit; apply_patch (applies a structured patch/diff) |
