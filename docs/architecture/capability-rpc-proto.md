...
- [src/hey_robot/foundation/contract/v1/__init__.py](../../src/hey_robot/foundation/contract/v1/__init__.py)
- [src/hey_robot/foundation/contract/v1/capability_pb2.py](../../src/hey_robot/foundation/contract/v1/capability_pb2.py)
- [src/hey_robot/foundation/contract/v1/capability_pb2.pyi](../../src/hey_robot/foundation/contract/v1/capability_pb2.pyi)
- [src/hey_robot/foundation/contract/v1/capability_pb2_grpc.py](../../src/hey_robot/foundation/contract/v1/capability_pb2_grpc.py)
...
```text
src/hey_robot/foundation/contract/v1/
  capability_pb2.py
  capability_pb2.pyi
...
3. 同时生成：
   ...
   - `--pyi_out`
   - `--grpc_python_out`
4. 将 generated file 移动到 `src/hey_robot/foundation/contract/v1/`
...
```python
from hey_robot.foundation.contract.v1 import ExecuteCapabilityRequest
```
...
- generated gRPC import 必须指向 `hey_robot.foundation.contract.v1`
...
src/hey_robot/foundation/contract/v2/
```
